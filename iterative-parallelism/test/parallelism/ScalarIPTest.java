...
public class ScalarIPTest<P extends info.kgeorgiy.java.advanced.concurrent.ScalarIP> extends BaseTest {
    ...
    public void test01_maximum() throws InterruptedException {
        test(Collections::max, info.kgeorgiy.java.advanced.concurrent.ScalarIP::maximum, comparators);
    }

    @Test
    public void test02_minimum() throws InterruptedException {
        test(Collections::min, info.kgeorgiy.java.advanced.concurrent.ScalarIP::minimum, comparators);
    }

    @Test
    public void test03_all() throws InterruptedException {
        test((data, predicate) -> data.stream().allMatch(predicate), info.kgeorgiy.java.advanced.concurrent.ScalarIP::all, predicates);
    }

    @Test
    public void test04_any() throws InterruptedException {
        test((data, predicate) -> data.stream().anyMatch(predicate), info.kgeorgiy.java.advanced.concurrent.ScalarIP::any, predicates);
    }
    ...
    protected double speedup(final List<Integer> data, final Comparator<Integer> comparator, final int threads) throws InterruptedException {
        ...
        final ConcurrentFunction<P, Integer, Comparator<Integer>> maximum = info.kgeorgiy.java.advanced.concurrent.ScalarIP::maximum;
        for (int i = 0; i < 5; i++) {
